...
export function matchingPasswords(passwordKey: string, confirmPasswordKey: string) {
 ...
 // max length
 export function maxLength(max: number): ValidatorFn | any {
...
// between length
export function betweenLength(min: number, max: number): ValidatorFn | any {
    return (control: AbstractControl[]) => {
        if (!(control instanceof FormArray)) return;
...
export function equalsToSomeGroupKey(key: string, toCompare: number | string, strict: boolean = false): ValidatorFn | any {
    return (control: AbstractControl[]) => {
        if (!(control instanceof FormArray)) return;
...
export function equalsToSomeElement(toCompare: number | string, strict: boolean = false): ValidatorFn | any {
    return (control: AbstractControl[]) => {
        if (!(control instanceof FormArray)) return;
...
export function keyExistsInGroups(key: string): ValidatorFn | any {
    return (control: AbstractControl[]) => {
        if (!(control instanceof FormArray)) return;
...
export function keyExistsInAtLeastOneGroup(key: string): ValidatorFn | any {
    return (control: AbstractControl[]) => {
        if (!(control instanceof FormArray)) return;
